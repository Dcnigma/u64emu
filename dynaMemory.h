...
extern WORD dynaOpLdl(BYTE* cp, BYTE op0, BYTE op1, DWORD Imm);
extern WORD dynaOpLdr(BYTE* cp, BYTE op0, BYTE op1, DWORD Imm);
extern WORD dynaOpSdl(BYTE* cp, BYTE op0, BYTE op1, DWORD Imm);
extern WORD dynaOpSdr(BYTE* cp, BYTE op0, BYTE op1, DWORD Imm);
extern WORD dynaOpLwl(BYTE* cp, BYTE op0, BYTE op1, DWORD Imm);
extern WORD dynaOpLwr(BYTE* cp, BYTE op0, BYTE op1, DWORD Imm);
extern WORD dynaOpSwr(BYTE* cp, BYTE op0, BYTE op1, DWORD Imm);
extern WORD dynaOpSwl(BYTE* cp, BYTE op0, BYTE op1, DWORD Imm);
